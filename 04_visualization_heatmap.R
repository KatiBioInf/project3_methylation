...
EnrichedHeatmap(mat, col = c("blue", "white", "red"), name = "diff. methylation", axis_name_rot = 90,
                column_title = "Differential methylation near CpG islands")
...
set.seed(123)
EnrichedHeatmap(mat, col = c("blue", "white", "red"), name = "diff. methylation", row_km = 4,
                top_annotation = HeatmapAnnotation(enriched = anno_enriched(gp = gpar(col = 2:4, lty = 1:3))),
                column_title = "Differential methylation in and near CpG islands", row_title_rot = 0)

set.seed(123)
EnrichedHeatmap(mat, col = c("blue", "white", "red"), name = "diff. methylation", row_km = 3,
                top_annotation = HeatmapAnnotation(enriched = anno_enriched(gp = gpar(col = 2:4, lty = 1:3))),
                column_title = "Differential methylation in and near CpG islands, tumor vs. normal", row_title_rot = 0)